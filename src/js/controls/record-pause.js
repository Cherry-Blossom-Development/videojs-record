...
*/
class RecordPause extends Button {
    /**
 ...
 * @private
 */
RecordPause.prototype.controlText_ = 'Pause4werweerw';

Component.registerComponent('RecordPause', RecordPause);
